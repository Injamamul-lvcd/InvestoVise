        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-semibold mb-3">Understanding SIP Investments</h2>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-semibold mb-3">Credit Card Rewards Guide</h2>
              <p className="text-gray-600 mb-4">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-semibold mb-3">Home Loan EMI Calculator</h2>
              <p className="text-gray-600 mb-4">
