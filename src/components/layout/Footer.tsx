  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Fixed Deposits', href: '/investing/fixed-deposits' },
      ]
    },
    {
      title: 'Personal Finance',
      links: [
        { name: 'Tax Planning', href: '/personal-finance/tax-planning' },
        { name: 'Insurance', href: '/personal-finance/insurance' },
        { name: 'Retirement Planning', href: '/personal-finance/retirement' },
        { name: 'Budgeting', href: '/personal-finance/budgeting' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Compare Brokers', href: '/brokers/compare' },
      ]
    },
    {
      ...
      links: [
        ...
        { name: 'Economic News', href: '/news/economy' },
      ]
    },
    {
      title: 'Company',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              {/* Bull Logo */}
              <div className="relative w-10 h-10 rounded-2xl flex items-center justify-center bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 shadow-lg shadow-amber-500/25">
                <svg className="w-6 h-6 text-white drop-shadow-sm" viewBox="0 0 32 32" fill="currentColor">
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">InvestoVise</h3>
                <p className="text-sm font-semibold text-amber-600 dark:text-amber-400 uppercase tracking-wide">Wealth Builder</p>
              </div>
            </div>
            <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-6">
              Your trusted partner for financial education and investment guidance in India. 
              Make informed decisions with our comprehensive tools and expert insights.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6 text-xs text-slate-500 dark:text-slate-500">
        ...
        <div className="mt-8 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
          <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
            <strong>Disclaimer:</strong> InvestoVise provides educational content and tools for informational purposes only. 
            We are not SEBI registered investment advisors. All investment decisions should be made after consulting with 
            qualified financial advisors. Past performance does not guarantee future results. Investments are subject to 
