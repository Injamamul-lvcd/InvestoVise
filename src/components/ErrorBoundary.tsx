    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-900 transition-colors duration-200">
          <div className="max-w-md w-full bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6 transition-colors duration-200">
            <div className="flex items-center mb-4">
              ...
              <div className="ml-3">
                <h3 className="text-lg font-medium text-gray-900 dark:text-white transition-colors duration-200">Something went wrong</h3>
              </div>
            </div>
            <div className="mb-4">
